  ...
  return (
    <div className="min-h-screen bg-[#0f1a2b] flex items-center justify-center text-slate-100 px-6">
      <div className="max-w-md w-full bg-[#152238] border border-white/10 rounded-xl p-6">
        <div className="text-2xl font-bold mb-4">Entrar</div>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <button type="submit" className="w-full bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white font-semibold">Entrar</button>
        </form>
        <div className="mt-4 text-sm text-slate-300">Não tem conta? <Link to="/register" className="text-blue-400">Criar conta</Link></div>
      </div>
    </div>
  );
}
